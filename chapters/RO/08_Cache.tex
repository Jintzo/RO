...
\paragraph{Cache --- Funktionsweise}
\begin{items}
...
\paragraph{Cache-Speicher --- Organisation}
\begin{items}
...
\paragraph{Cache-Speicher --- direct mapped-Cache}
\begin{items}
...
\paragraph{Cache-Speicher --- Ersetzungsstrategien}
\begin{items}
...
\paragraph{Bus-Schnüffeln (Snooping)}
\begin{items}
